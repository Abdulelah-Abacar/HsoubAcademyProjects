      ...
      >
        {!message ? (
          <CardContent sx={{ mb: 12 }}>
            ...
            >
              تطبيق علمني لتعليم اللغة الإنجليزية
            </Typography>
            <Typography variant="p" component="p">
              من خلال هذا التطبيق تتسطيع تعلم اللغة الإنجليزية من خلال أربع
              خطوات لكل قاعدة من قواعد اللغة الإنجليزية، النقاط الأربعة هي:
            </Typography>
            <List component="ul">
              {[
                "شرح للدرس بشكل كامل",
            ...
            <Box component="div" sx={{ mt: 2 }}>
              <Typography variant="p" component="p">
                يمكنك الوصول إلى هذه الأقسام من القائمة الجانبية على اليمين،{" "}
              </Typography>
              <Typography variant="p" component="p">
                أولًا اختار الدرس الذي تريده ومن ثم اضغط عليه، ستظهر قائمة صغيرة
                بأربع أقسام شرح الدرس والأسئلة والمحادثة وأخيرًا الترجمة.
              </Typography>
              <Typography variant="p" component="p">
                سيظهر لك القسم الذي اخترته وذلك من خلال ChatGPT والذي استخدمناه
                ليساعدك على تعلم اللغة الإنجليزية.
              </Typography>
            </Box>
            <Box component="div" sx={{ mt: 2 }}>
              <Typography variant="p" component="p">
                أيضًا في الأسفل لديك قسم اسألني وهذا القسم يمكنك من خلاله الحديث
                مع ChatGPT وسؤاله عن ماتريد أن يشرح لك أو يساعدك فيه.
              </Typography>
            </Box>
          </CardContent>
        ) : (
